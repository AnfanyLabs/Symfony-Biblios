 ...
 */
final class Version20250304223742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id SERIAL NOT NULL, editor_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(255) NOT NULL, cover VARCHAR(255) DEFAULT NULL, edited_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, plot VARCHAR(255) DEFAULT NULL, page_number INT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
